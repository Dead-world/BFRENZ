...
export default function ResetPasswordPage() {
  ...
  // 🛡️ Security Check: Ensure Supabase parsed a recovery access token from the active URL path
  useEffect(() => {
        ...
        <form onSubmit={handlePasswordUpdate}>
          <div className="reset-form-group">
            ...
            <input 
              ...
              disabled={isSubmitting || status.text.includes('successfully')}
            />
          </div>
          ...
          <button 
            ...
            disabled={isSubmitting || status.text.includes('successfully') || status.text.includes('Security Exception')}
          >
            {isSubmitting ? 'Updating Account...' : 'Apply New Password'}
          </button>

          {status.text && (
            <div className={`reset-status-alert ${status.type}`}>
