    ...
    <nav style={styles.nav}>
      ...
      {user && (
        <div className="nav-links-container" ref={dropdownRef}>
          ...
          {/* Menu Activation Trigger Image Badge */}
          ...
          {/* 📂 INTERACTIVE ACCORDION DROP POPUP PANEL */}
          {isDropdownOpen && (
